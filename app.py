...
with ui.panel_conditional("input.toggle_button % 2 == 1"):
    with ui.layout_columns():
        ...
        ui.input_numeric(
            "sig_meas",
            "Measurement StdDev (measurement variation)",
            0.38,
            min=0,
            step=0.1,
        )
...
def plot():
    ...
    mu_inst_post, sig_inst_post = bayesian_update_normal(mu_pop, y1, sig_pop_tot, sig_meas)
    alpha_meas = 0.5
    alpha_pop = 0.6
